...
export default function UserTable({ onRefresh }: UserTableProps) {
  ...
  const fetchUsers = async () => {
    ...
    try {
      ...
      const response = await axios.get('/api/superadmin/users/list', { params });
              ...
              {users.map((user) => (
                <tr key={user._id} className="hover:bg-gray-50">
                    ...
                    <div>
                      ...
                      {user.residentDetails && (
                        <div className="text-sm text-gray-500">
                          Unit {user.residentDetails.unitNumber} • {user.residentDetails.phone}
                        </div>
                      )}
                    </div>
                  </td>
                  ...
                  <td className="px-6 py-4 text-sm text-gray-900">
                    ...
                    <div className="text-xs text-gray-500">{user.propertyId.type}</div>
                  </td>
                  <td className="px-6 py-4">
