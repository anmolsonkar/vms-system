...
export default function ResidentDashboardPage() {
  ...
  const statCards = [
    ...
    { label: 'Approved Today', value: stats.approved, icon: CheckCircle, color: 'bg-green-500' },
    { label: 'Currently Inside', value: stats.checkedIn, icon: UserCheck, color: 'bg-blue-500' },
  ];
    ...
    <DashboardLayout role="resident">
      <div className="space-y-6">
        <div>
          ...
          <p className="text-gray-600 mt-1">Welcome back! Here's your visitor overview.</p>
        </div>
