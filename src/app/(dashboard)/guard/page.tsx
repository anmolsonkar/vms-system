...
export default function GuardDashboardPage() {
  ...
  const fetchStats = async () => {
    ...
    try {
      ...
      const activeVisitors = activeRes.data.success ? activeRes.data.data.visitors : [];
      const exitMarked = activeVisitors.filter((v: any) => v.markedExitAt).length;

      setStats({
        pending: pendingRes.data.success ? pendingRes.data.data.visitors.length : 0,
        approved: approvedRes.data.success ? approvedRes.data.data.visitors.length : 0,
    ...
    <DashboardLayout role="guard">
      <div className="space-y-6">
        <div>
          ...
          <p className="text-gray-600 mt-1">Monitor and manage visitor access</p>
        </div>
        ...
        <Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              ...
              <p className="text-sm text-gray-500 mt-1">Check visitors awaiting approval</p>
            </a>
            ...
            >
              ...
              <p className="text-sm text-gray-500 mt-1">See who's currently inside</p>
            </a>
            ...
            >
              ...
              <p className="text-sm text-gray-500 mt-1">Register walk-in visitors</p>
            </a>
          </div>
        </Card>
      </div>
